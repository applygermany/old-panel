        ...
        <main>
            ...
            <div class="part">
                ...
                <p> ۶-۶ متقاضی موظف است پس از اخذ روادید تحصیلی، تصویر روادید تحصیلی خود را در اختیار طرف اول
                    قرارداد قرار دهد.</p>
                <p> ۷-۶ متقاضی با امضای این قرارداد، موافقت ضمنی خود را با انتشار تصاویر پذیرش ها و روادید تحصیلی،
                    با رعایت اصول حفظ حریم شخصی، در صفحات مجازی و همچنین وبسایت اپلای جرمنی اعلام میدارد.</p>
                <p>
                    ...
                    <tr>
                        <td style="width: 33.33%; text-align: left">
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    <td style="text-align: left"><p class="footer-p">021-91693731</p></td>
