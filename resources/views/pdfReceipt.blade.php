...
{{--@section('content')--}}
    ...
    <div class="pdfbody">
        <htmlpageheader name="page-header">
            <table id="header">
                <tr>
                    <td colspan="1"><img width="140" src="{{url('src/images/logo.svg')}}"></td>
...
{{--                        <td colspan="3" style="text-align: left">{{number_format($invoice->final_amount)}}--}}
{{--                            <span>{{$invoice->currency_title}}</span>--}}
{{--                        </td>--}}
{{--                    </tr>--}}
{{--                </table>--}}
...
{{--                    </td>--}}
{{--                    <td style="width: 38%">--}}
{{--                        <img src="{{url('src/images/mohr.png')}}" style="width: 80px"/>--}}
{{--                        <img src="{{url('src/images/sign.png')}}" width="80"/>--}}
{{--                    </td>--}}
...
{{--                                <tr>--}}
{{--                                    <td style="text-align: left"><p class="footer-p">021-91308152</p></td>--}}
...
{{--                    </tr>--}}
{{--                </table>--}}
{{--                <p>آدرس: تهران، پاسداران، بین خیابان اسلامی و پایدارفرد، بوستان هشتم، پلاک 67، واحد 3 &#160;&#160; |--}}
{{--                    &#160; کد پستی: &#160;1666679911</p>--}}
{{--            </div>--}}
{{--        </htmlpagefooter>--}}
