            ...
            <div class="container-fluid d-flex flex-stack">
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.faq') }}">سوالات متداول</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-200 w-5px h-2px"></span>
                        </li>
                    ...
                    <div class="col-12">
                        <div class="card card-xl-stretch mb-8">
                            ...
                            <div class="card-body py-3">
                                <form action="{{ route('admin.updateFaq') }}" method="post" class="row">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $faq->id }}">
                                    <div class="col-12">
                                        <div class="form-group float-label">
                                            <label for="question" class="header-label">سوال</label>
                                            <input type="text" name="question" class="form-control form-control-sm @if($errors->has('question')) is-invalid @endif" id="question" value="{{ $faq->question }}">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group float-label">
                                            ...
                                            <textarea name="answer" class="editor @if($errors->has('answer')) is-invalid @endif" id="answer">{{ $faq->answer }}</textarea>
