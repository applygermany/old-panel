        ...
        <div class="toolbar">
            <div class="container-fluid d-flex flex-stack">
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">ویرایش کامنت</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.comment') }}">کامنت ها</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-200 w-5px h-2px"></span>
                        </li>
                        <li class="breadcrumb-item text-dark">ویرایش کامنت</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card card-xl-stretch mb-8">
                            ...
                            <div class="card-body py-3">
                                <form action="{{ route('admin.updateComment') }}" method="post" class="row" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $comment->id }}">
                                    <div class="col-12 col-lg-4">
                                        <div class="form-group float-label">
                                            <label for="name" class="header-label">نام دانشجو</label>
                                            <input type="text" name="name" class="form-control form-control-sm @if($errors->has('name')) is-invalid @endif" id="name" placeholder="نام دانشجو" value="{{  $comment->name  }}">
                                            @if($errors->has('name'))
                                    ...
                                    <div class="col-12 col-lg-4">
                                        <div class="form-group float-label">
                                            ...
                                            <input type="text" name="university" class="form-control form-control-sm @if($errors->has('university')) is-invalid @endif" id="university" placeholder="نام دانشگاه" value="{{  $comment->university  }}">
                                    ...
                                    <div class="col-12 col-lg-4">
                                        <div class="form-group float-label">
                                            ...
                                            <input type="text" name="field" class="form-control form-control-sm @if($errors->has('field')) is-invalid @endif" id="field" placeholder="رشته" value="{{ $comment->field  }}">
                                            @if($errors->has('field'))
                                    ...
                                    <div class="col-12 col-lg-8">
                                        <div class="form-group float-label">
                                            ...
                                            <textarea rows="4" type="text" name="text" class="form-control form-control-sm @if($errors->has('text')) is-invalid @endif" id="text" placeholder="متن">{{  $comment->text  }}</textarea>
                                            @if($errors->has('text'))
                                    ...
                                    <div class="col-12 col-lg-4">
                                        <div class="form-group float-label">
                                            ...
                                            <input type="text" name="rating" class="form-control form-control-sm @if($errors->has('rating')) is-invalid @endif" id="rating" placeholder="امتیاز" value="{{  $comment->rating  }}">
