            ...
            <tr class="text-center">
                ...
                <td>
                    @if($resume->url_uploaded_from_admin != '')
                       <a href="{{$resume->url_uploaded_from_admin}}">دانلود</a>
               @else
                __
               @endif
               </td>
                <td>
                    <?php
                    $date = explode(' ',$resume->created_at);
                    $date = explode('-',$date[0]);
                ...
                <th>
                    <a href="{{route('admin.showResume', ["id" => $resume->id])}}"><button class="btn btn-danger">نمایش</button></a>
                </th>
            </tr>
        @endforeach
        </tbody>
