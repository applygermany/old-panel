            ...
            <div class="container-fluid d-flex flex-stack">
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark"> بارگذاری جدول</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card card-xl-stretch mb-8">
                            ...
                            <div class="card-body py-3">
                                <form action="{{ route('admin.doImports') }}" method="post" class="row" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-12 col-md-12">
                                        <div class="form-group float-label">
                                            <label for="json" class="header-label">فایل JSON</label>
                                            <input type="file" name="json" class="form-control form-control-sm @if($errors->has('json')) is-invalid @endif" id="json">
                                            @if($errors->has('json'))
                                                <div class="invalid-feedback"><small>{{ $errors->first('json') }}</small></div>
                                            @endif
                                        </div>
                                    </div>
