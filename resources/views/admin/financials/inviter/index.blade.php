            ...
            <div class="container-fluid d-flex flex-stack">
                <div data-kt-place="true" data-kt-place-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">تخفیف های معرف</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card card-xl-stretch mb-8">
                            ...
                            <div class="card-body collapse py-3" id="collapseNewOff">
                                <form action="{{ route('admin.saveOffInviter') }}" method="post" class="row">
                                    @csrf
                                    <div class="col-4 d-none">
                                        <div class="form-group float-label">
                                            ...
                                            <select name="type" class="form-control form-select-sm" id="type">
                                                ...
                                                <option selected value="fixed">مقداری</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group float-label">
                                            ...
                                            <input type="text" name="discount"
                                                   class="form-control form-control-sm @if($errors->has('discount')) is-invalid @endif"
                                                   id="discount" placeholder="مقدار تخفیف">
                                    ...
                                    <div class="col- d-none">
                                        <div class="form-group float-label">
                                            ...
                                            <select name="off_type" id="off_type" class="form-control form-select-sm"
                                                    data-control="select2">
                                                <option value="">انتخاب کنید</option>
                                                {{--                                                <option value="resume">رزومه و انگیزه نامه</option>--}}
                                                {{--                                                <option value="tel-support">مشاوره تلفنی</option>--}}
                                                <option selected value="final">تسویه نهایی</option>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group float-label">
                                            ...
                                            <input type="text" name="start_date"
                                                   class="form-control form-control-sm date @if($errors->has('start_date')) is-invalid @endif"
                                                   id="start_date" placeholder="از تاریخ">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group float-label">
                                            ...
                                            <input type="text" name="end_date"
                                                   class="form-control form-control-sm date @if($errors->has('end_date')) is-invalid @endif"
                                                   id="end_date" placeholder="تا تاریخ">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group float-label">
                                            <label class="header-label" for="user">معرف</label>
                                            <select name="code" id="code" class="form-control form-select-sm"
                                                    data-control="select2">
                                                <option value="">انتخاب کنید</option>
                                                @foreach($users as $user)
                                                    <option value="{{ $user->id }}">{{ $user->firstname }} {{ $user->lastname }}</option>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="form-group float-label">
                                            <label for="discount_code" class="header-label">کد معرف</label>
                                            <input type="text" name="discount_code" class="form-control form-control-sm"
                                                   id="discount_code" placeholder="کد معرف">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group float-label">
                                            ...
                                            <input type="text" name="max"
                                                   class="form-control form-control-sm @if($errors->has('max')) is-invalid @endif"
                                                   id="max" placeholder="تعداد">
                                            @if ($errors->has('max'))
                                    ...
                                    <div class="col-4 d-none">
                                        <div class="form-group float-label">
                                            ...
                                            <input type="text" name="userMax"
                                                   class="form-control form-control-sm @if($errors->has('userMax')) is-invalid @endif"
                                                   id="userMax" placeholder="تعداد">
                        ...
                        <div class="card card-xl-stretch mb-8">
                            ...
                            <div class="card-body py-3">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="form-group float-label">
                                            <label for="searchCode" class="header-label">کد معرف</label>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="row">
                                            <button type="button" id="search" class="btn btn-primary btn-sm col-6">
                                                جستجو
                                            </button>

                                            <form action="{{route('admin.off.exports.inviter')}}" method="post"
                                                  class=" col-6">
                                                @csrf
                                                <input type="hidden" name="exportUser" id="exportUser">
                                                <input type="hidden" name="exportCode" id="exportCode">
                                                <button type="submit" id="export" class="btn btn-info btn-sm col-12">
                                                    خروجی اکسل
                                                </button>
                                            </form>
                                        </div>
                ...
                <div class="row g-5 g-xl-8">
                    <div class="col-12">
                        <div class="card card-xl-stretch mb-8">
                            ...
                            <div class="card-body py-3">
                                <div id="tableBox">
                                    @include('admin.financials.inviter.list')
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        function getOffs(page) {
            ...
            $.ajax({
                url: '{{ route('admin.getOffsInviter') }}' + "?page=" + page,
                type: "POST",
                data: {
                    _token: '{{ csrf_token() }}',
        ...
        $(document).on('click', '#search', function () {
            ...
            $.ajax({
                url: '{{ route('admin.getOffsInviter') }}',
                type: "POST",
                data: {
                    _token: '{{ csrf_token() }}',
                    searchUser: $('#searchUser').val(),
