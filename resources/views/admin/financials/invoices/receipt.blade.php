        ...
        <div class="container-fluid d-flex flex-stack">
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-dark">رسید ها</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="card card-xl-stretch mb-8">
                        ...
                        <div class="card-body py-3">
                            <div class="row">
                                ...
                                <input type="hidden" id="invoiceTitle" name="invoiceTitle" value="receipt">
            ...
            <div class="row g-5 g-xl-8">
                <div class="col-12">
                    <div class="card card-xl-stretch mb-8">
                        ...
                        <div class="card-body py-3">
                            <div id="tableBox">
                                @include('admin.financials.invoices.partials.list-receipt')
                            </div>
                        </div>
                    </div>
                </div>
