...
<div class="row">
    ...
    <div class="col-12 col-lg-4">
        <div class="form-group float-label">
            ...
            <select name="payment_method" id="paymentMethod" disabled onchange="selectPaymentMethod(this)"
                    class="form-control form-select-sm" data-control="select2">
                <option value="" selected>انتخاب کنید</option>
    ...
    <div class="col-12 col-lg-4">
        <div class="form-group float-label">
            ...
            <select name="bankAccount" id="bankAccount" disabled {{$invoice->payment_method === 'cash' ? 'disabled' : ''}}
                    class="form-control form-select-sm" data-control="select2">
                <option value="" selected>انتخاب کنید</option>
    ...
    <div class="col-12 col-lg-4">
        <div class="form-group float-label">
            ...
            <input type="text" name="ir_amount" disabled value="{{$invoice->ir_amount}}"
    ...
    <div class="col-12 col-lg-4">
        <div class="form-group float-label">
            ...
            <input type="text" name="invoice_description" value="{{$invoice->invoice_description}}"
                   ...
                   id="invoice_description" placeholder="توضیحات" disabled>
    ...
    <div class="col-12 col-lg-4">
        <div class="form-group float-label">
            ...
            <input type="text" name="paymentAt" disabled value="{{$invoice->payment_at}}" required
