...
class JDF extends ServiceProvider
{
	public static function fa_to_en($number) {
    ...
    public static function gregorian_to_jalali($gy, $gm, $gd, $mod = '')
    {
        ...
        return ($mod == '') ? array($jy, $jm, $jd) : $jy . $mod . ($jm < 10 ? "0$jm" : $jm) . $mod . ($jd < 10 ? "0$jd" : $jd);
    }
    ...
    public static function jalali_to_gregorian_($date, $mod = '')
    {
